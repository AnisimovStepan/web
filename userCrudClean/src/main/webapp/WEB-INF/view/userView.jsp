        ...
        <div class="container transparent-bg-light">
            ...
            <div class="flex-center">
                <form class="container-block" method="POST" style="width: 60%;" action="${pageContext.request.contextPath}${servletUrl}">
                    ...
                    <div class="form__row">
                        <input class="form-input" type="text" name="last-name" placeholder="Last name" value="${user.lastName}" autocorrect="off" autocapitalize="none" draggable="false">
                    </div>

                    <div class="form__row">
                        <input class="form-input" type="text" name="middle-name" placeholder="Middle name" value="${user.middleName}" autocorrect="off" autocapitalize="none" draggable="false">
                    </div>
